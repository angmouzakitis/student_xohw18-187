...
//------------------------Instantiation------------------
// four_port_sw_out_2_request_preprocessor
four_port_sw_out_2_request_preprocessor #(
...
module four_port_sw_out_2_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
module four_port_sw_out_2_write/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
module four_port_sw_out_2_read/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// four_port_sw_out_2_read_data_align
four_port_sw_out_2_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module four_port_sw_out_2_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
module four_port_sw_out_2_fifo/*{{{*/
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module four_port_sw_out_2_reg_slice/*{{{*/
#(parameter
    N = 8   // data width
) (
    // system signals
